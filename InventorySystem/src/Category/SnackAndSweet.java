...
public class SnackAndSweet extends Item implements NumberItems{
	
	private String brand;
	private int numOfItems;
	private boolean isLocal;//local or imported

	public SnackAndSweet() {
		super();
	}

	public SnackAndSweet( String itemName, float retailPrice, float discount,  float promotion,int numOfItems,boolean isLocal,String brand) {
