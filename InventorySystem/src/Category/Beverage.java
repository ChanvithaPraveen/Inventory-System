...
public class Beverage extends Item implements NumberItems{
	...
	public Beverage( String itemName, float retailPrice, float discount,  float promotion,int numOfItems,boolean isLocal,String brand) {
