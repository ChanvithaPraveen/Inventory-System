...
public class CondimentAndSpice extends Item implements NumberItems {
	
	private String brand;
	private int numOfItems;
	private boolean isLocal;//local or imported

	public CondimentAndSpice() {
		super();
	}

	public CondimentAndSpice( String itemName, float retailPrice, float discount,  float promotion,int numOfItems,boolean isLocal,String brand) {
