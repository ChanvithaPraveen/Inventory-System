...
public class MeatAndSeaFood extends Item implements WeightItems{
	...
	public MeatAndSeaFood( String itemName, float retailPrice, float discount,  float promotion,float weight) {
