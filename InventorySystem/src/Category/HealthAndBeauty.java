...
public class HealthAndBeauty extends Item implements NumberItems {
	...
	public HealthAndBeauty( String itemName, float retailPrice, float discount,  float promotion,int numOfItems,boolean isLocal,String brand) {
