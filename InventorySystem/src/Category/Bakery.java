...
public class Bakery extends Item  {
	...
	public Bakery( String itemName, float retailPrice, float discount,  float promotion,int numOfItems,boolean isLocal,String brand) {
